...
/*whenever button is clicked this function runs*/
function fun(){ 
    ...
    /*making the id change each time*/
    ...
    let h1=document.createElement('h1');
        ...
        function funn(){
            let color=['red', 'orange', 'yellow', 'green', 'blue', 'purple', 'black', 'brown']
